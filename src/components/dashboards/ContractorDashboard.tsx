...
export function ContractorDashboard() {
  ...
  return (
    <div className="space-y-6">
      ...
      >
        {[
          { icon: Camera, label: 'Upload Evidence', desc: 'Add work photos', color: 'from-primary-500 to-primary-600' },
          { icon: FileText, label: 'Submit Report', desc: 'Daily progress', color: 'from-accent-500 to-accent-600' },
          { icon: Users, label: 'Workforce Log', desc: 'Attendance & tasks', color: 'from-warning-500 to-warning-600' },
          { icon: Wallet, label: 'Budget Request', desc: 'Additional funds', color: 'from-purple-500 to-purple-600' }
        ].map((action, i) => (
          <Card key={i} variant="bordered" hover className="cursor-pointer">
